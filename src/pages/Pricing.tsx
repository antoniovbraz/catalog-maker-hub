  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Calcule preços sugeridos e margens de lucro</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Informe os dados necessários para calcular o preço sugerido
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Resultados dos cálculos de preço e margem
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {pricingResult && (
