-- Corrigir as funções para aplicar imposto sobre o valor de venda
...
BEGIN
  ...
  -- Calcular preço sugerido considerando que o imposto será aplicado sobre o valor de venda:
  -- Fórmula: (custo_total + fixo + frete) / (1 - (comissão + taxa_cartao + provisao_desconto + margem_desejada + imposto)/100)
