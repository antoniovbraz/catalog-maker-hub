-- Corrigir as funções para tratar corretamente os valores percentuais
...
BEGIN
  ...
  -- Calcular preço sugerido usando TODOS os inputs do usuário:
  -- Fórmula: (custo_total + fixo + frete) / (1 - (comissão + taxa_cartao + provisao_desconto + margem_desejada)/100)
  ...
  -- Calcular margem unitária e percentual considerando TODOS os custos sobre o preço de venda
...
-- Corrigir função de margem real também
...
BEGIN
  ...
  -- Calcular margem real considerando TODOS os inputs sobre o preço praticado
